...
# TODO: Dont put api key here.
headers = {
    "X-Riot-Token": "RGAPI-9b744f9a-3d71-42fd-806a-2e0d6456132f"
}


def get_account_id(username: str):
    endpoint = "/lol/summoner/v4/summoners/by-name/%s" % username
    raw_response = requests.get(API_URL + endpoint, headers=headers)
...
def set_active_game(user: User, summoner_id: str, game: Game):
...
def process_game_result(user, game_id):
